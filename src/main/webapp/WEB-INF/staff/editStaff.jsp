    ...
    <div class="pagebody12">
        ...
        <ul>
            ...
            <table width="290" class="fl pagebody12_right">
              <tr class="border_end">
                <td width="290" height="50">${company.companyCode}</td>
              </tr>
              <tr class="border_end">
              ...
              <c:forEach var="city" items="${cityList}">
                  <c:if test="${city.id == company.province}">
              <tr class="border_end">
                <td width="290" height="50">${city.shortName}</td>
              </tr>
                  </c:if>
                  <c:if test="${city.id == company.city}">
              <tr class="border_end">
                <td width="290" height="50">${city.name}</td>
              </tr>
                  </c:if>
                  <c:if test="${city.id == company.county}">
              <tr>
                <td width="290" height="50">${city.name} </td>
              </tr>
                  </c:if>
